...
WHITE = (255,255,255) #Defined variable WHITE as rgb tuple value
BLACK = (0,0,0)
RED = (255, 0, 0)
YELLOW =  (255, 255, 0)
...
def draw_window(red, yellow, red_bullets, yellow_bullets, red_health, yellow_health): #function that handles drawing things onto the screen
    #WIN.fill(WHITE) #Fill the screen with white color
    WIN.blit(SPACE, (0,0))
    pygame.draw.rect(WIN, BLACK, BORDER) #Draw the border by passing border rectangle object to draw.rect()
    ...
    WIN.blit(YELLOW_SPACESHIP, (yellow.x, yellow.y)) #Draw the spaceship to the screen at the given coordinates
    ...
    pygame.display.update() #Make update to the screen to show all changes made
